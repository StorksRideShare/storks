...
ALTER TABLE users
    ADD CONSTRAINT uc_users_provider_user UNIQUE (provider_user_id);
...
ALTER TABLE driver_licences
    ALTER COLUMN license_number TYPE VARCHAR(255) USING (license_number::VARCHAR(255));

ALTER TABLE vehicles
    ALTER COLUMN license_plate TYPE VARCHAR(255) USING (license_plate::VARCHAR(255));
...
ALTER TABLE parents
    ADD payment_preferred VARCHAR(255);

ALTER TABLE children
    ALTER COLUMN pronouns TYPE VARCHAR(255) USING (pronouns::VARCHAR(255));
