  ...
  return (
    <SafeAreaView className="flex-1 ">
      ...
      <VStack className="flex-1 px-5" space="md">
        {/* Child selector card */}
        <Box className=" p-4 rounded-3xl mt-4 mb-4">
        ...
        {/* Calendar box */}
        <Box className=" p-6 rounded-[32px] border border-outline-700 mb-6">
          {/* Month header */}
        ...
        {/* Time slot card */}
        <Box className="border border-dashed border-outline-600 rounded-3xl p-6 ">
          <VStack space="lg">
            {[1, 2].map((i) => (
