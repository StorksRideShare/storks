...
const Dashboard: React.FC = () => {
  ...
  const fetchMetrics = async () => {
    try {
      ...
      const newData =
        await apiClient.get<MetricsResponse>("/api/admin/metrics");
    ...
    <div style={{ padding: "20px", maxWidth: "1200px", margin: "0 auto" }}>
      ...
      >
        ...
        >
          <h3>CPU Usage</h3>
          <p
            style={{ fontSize: "2.5rem", fontWeight: "bold", color: "#1565c0" }}
          >
            {metrics.cpuUsage}%
          </p>
        </div>
        ...
        >
          ...
          <p
            style={{ fontSize: "2.5rem", fontWeight: "bold", color: "#ef6c00" }}
          >
      ...
      <section style={{ marginBottom: "40px" }}>
        ...
        <ul style={{ textAlign: "left", maxWidth: "600px", margin: "0 auto" }}>
          <li>
            🚗 Ride ID: 1 - Status:{" "}
            <span style={{ color: "#4CAF50" }}>Active</span> - Driver: John
          </li>
          <li>
            ✅ Ride ID: 2 - Status:{" "}
            <span style={{ color: "#2196F3" }}>Completed</span> - Driver: Jane
          </li>
          <li>
            🚗 Ride ID: 3 - Status:{" "}
            <span style={{ color: "#4CAF50" }}>Active</span> - Driver: Mike
          </li>
        </ul>
      </section>
      ...
      <section style={{ marginBottom: "40px" }}>
        ...
        <div style={{ display: "flex", justifyContent: "center" }}>
          <LineChart
            width={700}
            height={350}
            data={chartData.length > 0 ? chartData : mockMetricsData}
          >
...
const PrivacySettings: React.FC = () => {
  return (
    <div style={{ padding: "20px", maxWidth: "600px", margin: "0 auto" }}>
      ...
      <p>
        Share location only during ride:{" "}
        <input type="checkbox" checked readOnly />
      </p>
      <p>Data retention period: 30 days</p>
      <p>
        Opt out of analytics: <input type="checkbox" />
      </p>
    </div>
  );
};
